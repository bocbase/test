...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { category: @history.category, text: @history.text, ymd: @history.ymd } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { category: @history.category, text: @history.text, ymd: @history.ymd } }
